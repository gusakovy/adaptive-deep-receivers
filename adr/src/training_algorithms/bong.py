...
def dg_bong(
    ...
    """Train a neural network using the diagonal-covariance Gaussian Bayesian online natural gradient (BONG) algorithm.
    ...
    bong_result, _ = run_rebayes_algorithm(key, dg_bong, inputs, labels)
    return bong_result.mean, bong_result.cov
